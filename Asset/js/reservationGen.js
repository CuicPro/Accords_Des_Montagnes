document.addEventListener('DOMContentLoaded', () => {
    ...
    // Créer les éléments de sièges du haut
    topSeatsLayout.forEach(seat => {
        const seatElement = document.createElement('div');
        seatElement.classList.add('top-seat');
        ...
        topSeatsContainer.appendChild(seatElement);
    });
    ...
    // Créer les éléments de sièges de gauche
    leftSeatsLayout.forEach(seat => {
        const seatElement = document.createElement('div');
        seatElement.classList.add('left-seat');
        seatElement.style.gridColumn = seat.column;
        seatElement.style.gridRow = seat.row;
        seatElement.dataset.seatNumber = seat.id;
        seatElement.addEventListener('click', () => {
        ...
        leftSeatsContainer.appendChild(seatElement);
    });
    ...
    // Créer les éléments de sièges du bas
    bottomSeatsLayout.forEach(seat => {
        const seatElement = document.createElement('div');
        seatElement.classList.add('bottom-seat');
        seatElement.style.gridColumn = seat.column;
        seatElement.style.gridRow = seat.row;
        seatElement.dataset.seatNumber = seat.id;
        seatElement.addEventListener('click', () => {
        ...
        bottomSeatsContainer.appendChild(seatElement);
    });
    ...
    payButton.addEventListener('click', () => {
        ...
        // Redirect to payment gateway with seatNumbers
    });
});
